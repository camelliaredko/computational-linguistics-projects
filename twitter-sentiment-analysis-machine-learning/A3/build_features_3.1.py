...
##     the command line to pass parameters). It is assumed that the input file is in the
...
def is_all_upper(s):
    # check if string contains all upper case characters
    for char in s:
        if not char.isupper():
            return False
    return True
...
def buildFeatureDictionary():
    dictionary = {
        ...
        "adore" : "Pos_verbs",
        "applaud" : "Pos_verbs",
        "appreciate" : "Pos_verbs",
        "bless" : "Pos_verbs",
        "celebrate" : "Pos_verbs",
        "cherish" : "Pos_verbs",
        "commend" : "Pos_verbs",
        "compensate" : "Pos_verbs",
        "compliment" : "Pos_verbs",
        "congratulate" : "Pos_verbs",
        "enjoy" : "Pos_verbs",
        "esteem" : "Pos_verbs",
        "eulogize" : "Pos_verbs",
        "exalt" : "Pos_verbs",
        ...
        "praise" : "Pos_verbs",
        "prize" : "Pos_verbs",
        "recompense" : "Pos_verbs",
        "relish" : "Pos_verbs",
        "remunerate" : "Pos_verbs",
        "repay" : "Pos_verbs",
        "respect" : "Pos_verbs",
        "revere" : "Pos_verbs",
        "reward" : "Pos_verbs",
...
def buildFeatures():
    ...
    infile_name = os.path.join(curdir, tagged_tweets)
